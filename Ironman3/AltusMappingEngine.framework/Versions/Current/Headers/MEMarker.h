...
/**The marker's altitude in meters.*/
...
/**Represents a tap on a marker object.*/
@interface MEMarkerTap : NSObject
/**The marker that was tapped.*/
@property (retain) MEMarker* meMarker;
/**The point on the screen where the tap occurred.*/
@property (assign) CGPoint screenPoint;
/**The point on the marker image where the tap occurred.*/
@property (assign) CGPoint markerPoint;
/**The name of the map on which the marker resdies.*/
