...
/**Colorbar name to use to fill the polygon.  This only applies to 3D polygons created with addDynamicLine3dSkirtToVectorMap.*/
@property (atomic, retain) NSString* colorbarName;
